<?php
	...
	function aiga_enqueues() {
		wp_enqueue_style( 'aiga', get_stylesheet_uri() );
		wp_enqueue_style( 'aiga-foundation', get_template_directory_uri() . '/css/app.css', array( 'aiga' ), '20140317' );

		wp_enqueue_script( 'jquery' );
	}
	add_action( 'wp_enqueue_scripts', 'aiga_enqueues' );
